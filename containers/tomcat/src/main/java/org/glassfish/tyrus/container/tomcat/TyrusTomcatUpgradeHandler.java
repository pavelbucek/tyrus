 ...
 * <p/>
 * Reads data from {@link javax.servlet.ServletInputStream} and passes it further to the
 * Tyrus runtime.
 *
 * @author Jitendra Kotamraju
 * @author Pavel Bucek (pavel.bucek at oracle.com)
 */
public class TyrusTomcatUpgradeHandler implements HttpUpgradeHandler, ReadListener {

    public static final String FRAME_BUFFER_SIZE = "org.glassfish.tyrus.servlet.incoming-buffer-size";

    private final CountDownLatch connectionLatch = new CountDownLatch(1);

    private AbstractServletInputStream is;
    private AbstractServletOutputStream os;
    ...
    private static final Logger LOGGER = Logger.getLogger(TyrusTomcatUpgradeHandler.class.getName());
    ...
    public void init(WebConnection wc) {
        ...
        connection = upgradeInfo.createConnection(writer, new Connection.CloseListener() {
            ...
            public void close(CloseReason reason) {
                try {
                    TyrusTomcatUpgradeHandler.this.getWebConnection().close();
                } catch (Exception e) {
